...
package com.billiecamera.camera.render.egl;
...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        EGL14.eglQueryContext(mEGLDisplay,
                ...
                values,
                0);
        Log.w(TAG, "EGLContext created, client version " + values[0]);
    }
    ...
    public void makeCurrent(EGLSurface drawSurface, EGLSurface readSurface) {
        ...
        if (!EGL14.eglMakeCurrent(mEGLDisplay, drawSurface, readSurface, mEGLContext)) {
            logCurrent("eglMakeCurrent(draw,read)");
            checkEglError("eglMakeCurrent(draw,read)");
    ...
    public void makeNothingCurrent() {
        if (!EGL14.eglMakeCurrent(mEGLDisplay, EGL14.EGL_NO_SURFACE, EGL14.EGL_NO_SURFACE, EGL14.EGL_NO_CONTEXT)) {
            checkEglError("makeNothingCurrent failed");
    ...
    public static void logCurrent(String msg) {
        ...
        Log.w(TAG, "Current EGL (" + msg + "): display=" + display + ", context=" + context + ", surface=" + surface);
    }
    ...
    private void checkEglError(String msg) {
        ...
        if ((error = EGL14.eglGetError()) != EGL14.EGL_SUCCESS) {
            throw new RuntimeException(msg + ": EGL error: 0x" + Integer.toHexString(error) + " " + queryString(error));
        }
    }
}
